...
public class DmlOperations {
  ...
  private QueryStatementFactory getStatementFactory(StatementAttributes statementAttributes, boolean streaming,
  ...
  private StatementResult executeUpdate(@ParameterGroup QueryDefinition query,
                                        @ParameterGroup StatementAttributes statementAttributes,
                                        @ParameterGroup AutoGeneratedKeyAttributes autoGeneratedKeyAttributes,
                                        @Connection DbConnection connection, Query resolvedQuery)
      throws SQLException {
  ...
  private Query resolveQuery(QueryDefinition query, DbConnector connector, DbConnection connection, QueryType... validTypes) {
  ...
  private AutoGeneratedKeyStrategy getAutoGeneratedKeysStrategy(AutoGeneratedKeyAttributes keyAttributes) {
